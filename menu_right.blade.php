...
<div class="panel">
    ...
    <div class="panel-content">
        <ul class="sitebar-list">
            ...
            <li><a href="{{url('sim-tien-kep')}}">Sim tiến kép</a></li>
            ...
            <li><a href="{{url('sim-ganh-kep')}}">Sim gánh kép</a></li>
...
<div class="panel">
    ...
    <div class="panel-content">
        <ul class="sitebar-list">
            ...
            <li><a href="{{url('sim-tien-doi')}}">Sim tiến đôi</a></li>
            <li><a href="{{url('sim-tra-gop')}}">Sim trả góp 0% ****</a></li>


            <li><a href="{{url('sim-kep')}}">Sim kép</a></li>
            <li><a href="{{url('sim-kep-ba')}}">Sim kép ba</a></li>
